...
<div class="login-container">
	<form action="NewPassword" class="form-login" method="post">
		<ul class="login-nav">
			<li class="login-nav__item active">
				<a>Neues Passwort Festlegen</a>
			</li>
		</ul>
		<label for="login-input-user" class="login__label">
			Code
		</label>
		<input name= "code" id="login-input-user" class="login__input" type="number" required="required" />
		
		<label for="login-input-password" class="login__label">
			Neues Password
		</label>
		<input name="newPass" id="login-input-password" class="login__input" type="password" required="required" />
		
		<label for="login-input-password" class="login__label">
			Neues Password Bestätigen
		</label>
		<input name="confirmNewPass" id="login-input-password" class="login__input" type="password" required="required" />
		
		<br><br><br><br>
		
		<button type="submit" class="login__submit">Neues Password Festlegen</button>
	</form>
</div>
