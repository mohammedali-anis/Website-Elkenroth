...
<div id="container">
  ...
  <form action="addBlogServlet" method="post" id="contact_form">
    <div class="from">
    ...
    <div class="title">
      ...
      <input type="text" placeholder="Beitragstitle" name="title" id="title_input" required>
    </div>
  ...
  <br>
    <div class="submit">
      ...
      <input type="submit" value="Anfrage Senden" id="send_button" onclick="clickAlert()"/>
...
<script>
 	String name= document.getElementbyId("Template");
 	con= null;
 	try{
 	String query = "Select template_description From Template Where template_name = '"+ name+"';";
 	Class.forName("org.sqlite.JDBC");
 	con = sqlConnection.connect();
 	Statement stm = con.createStatement();
 	document.getElementbyId("content").value = stm.executeQuery(Query);
 	}
 	catch(Exception ex){
 		ex.printStackTrace();
 		out.println("Error" + ex.getMessage());
