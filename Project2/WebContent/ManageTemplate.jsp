 ...
 * {
 ...
 <body>
 		...
 		<form action="addTemplate" method="POST">
 			<table id="template" class="fl-table">
 				...
 				<tbody>
 					...
 					String Query = "Select template_id, template_name, user_id, section_id, subsection, fromDate, toDate, website, terminal From Template Natural Join Section where Template.section_id in( Select section_id From Section Natural JOIN User_Section NATURAL Join User Where username ='" + Servlet.username + "'); ";
 					...
 					while (r.next()) {
 						...
 						String from = r.getString("fromDate");
 						String to = r.getString("toDate");
 	...
 	<script>
 		...
 		<!-- <input type="submit" name="act" value="Add Template"> -->
 		
 		<a href="http://localhost:8081/Project2/TemplateEditor.jsp" class = "add">Template Hinfügen</a>
