<%@page import="elbiscms.sqlConnection"%>
 ...
 <body>
 <div id="container">
   <h1>&bull; Template Hinfügen &bull;</h1>
   <div class="underline">
   </div>
   ...
   <form action="addTemplate" method="post" id="contact_form">
     <div class="title">
       ...
       <input type="text" placeholder="Templatestitel" name="title" id="title_input" required>
     </div>
   ...
   <br>
     <div class="submit">
       ...
       <input type="submit" name="act" value="Hinfügen" id="send_button" onclick="clickAlert()"/>
