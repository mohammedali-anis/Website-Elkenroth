...
<div class="login-container">
	<form action="Servlet" class="form-login" method="post">
		<ul class="login-nav">
		...
		<input name= "slct" id="login-input-user" class="login__input" type="text" required="required" />
		...
		<button type="submit" class="login__submit">Einloggen</button>
	</form>
	<a href="http://localhost:8081/Project2/ForgetPassword.jsp" class="login__forgot">Passwort Vergessen?</a>
</div>
