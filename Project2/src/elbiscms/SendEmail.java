...
public class SendEmail {
	...
	public static void emailResetPassword(String an, int code) {
		String to = an; // to address. It can be any like gmail, yahoo etc.
		String from = "noreply.elbis@gmail.com"; // from address. As this is using Gmail SMTP your from address should
													// be Gmail
		String password = "ProPra.ppgrp2";
		...
		try {
			...
			message.setText("We recived a request to reset your password !" + "\n" + "\n" + "You can enter the following password reset code : " + code + " to set a new password.");
